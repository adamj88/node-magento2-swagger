...
var Magento = (function() {
    ...
    function Magento(options) {
        ...
        this.domain = domain ? domain : 'http://magento.vg/rest/default';
    ...
    /**
     * Save quote
     * @method quoteCartRepositoryV1SavePut
     * @name Magento#quoteCartRepositoryV1SavePut
     * @param {} $body - 
     *
     */
    Magento.prototype.quoteCartRepositoryV1SavePut = function(parameters) {
        if (parameters === undefined) {
            parameters = {};
        }
        var deferred = Q.defer();
     ...
     * @method quoteShipmentEstimationV1EstimateByExtendedAddressPost
     * @name Magento#quoteShipmentEstimationV1EstimateByExtendedAddressPost
     * @param {string} cartId - 
     * @param {} $body - 
     *
     */
    Magento.prototype.quoteShipmentEstimationV1EstimateByExtendedAddressPost = function(parameters) {
        if (parameters === undefined) {
            parameters = {};
        }
        var deferred = Q.defer();
    ...
    /**
     * Estimate shipping by address and return list of available shipping methods
     * @method quoteGuestShipmentEstimationV1EstimateByExtendedAddressPost
     * @name Magento#quoteGuestShipmentEstimationV1EstimateByExtendedAddressPost
     * @param {string} cartId - 
     * @param {} $body - 
     *
     */
    Magento.prototype.quoteGuestShipmentEstimationV1EstimateByExtendedAddressPost = function(parameters) {
        if (parameters === undefined) {
            parameters = {};
        }
        var deferred = Q.defer();
     ...
     * @method salesCreditmemoManagementV1RefundPost
     * @name Magento#salesCreditmemoManagementV1RefundPost
     * @param {} $body - 
     *
     */
    Magento.prototype.salesCreditmemoManagementV1RefundPost = function(parameters) {
        if (parameters === undefined) {
            parameters = {};
        }
        var deferred = Q.defer();
